...
<head>
  ...
  <title>Ryzl Jeune E. Beltran | Welcome</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/favicon.png" rel="icon">
  <link href="assets/img/ry-icon.png" rel="ry-icon">
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Ryzl Beltran</h1>
      <p>Bold Women, <span class="typed" data-typed-items="Bright Future, Breaking Barriers, Defying Norms"></span></p>
      <div class="social-links">
        <a href="https://twitter.com/ayyyits_schwnnM" target="_blank" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="https://www.instagram.com/ry.zljn/" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
      </div>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Hi, I’m Ryzl Jeune, but you can call me Ry for short. I do love cafe hopping from various places, wanna join?</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            <h3>Multifaceted Professional</h3>
            <br>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>1 June 2002</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.ryzlbeltran.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+123 456 7890</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Marikina, Philippines</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>ryzlbeltran@gmail.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Status:</strong> <span>Working Student</span></li>
                </ul>
              </div>
            </div>
            <br>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">First Aid <i class="val">100%</i></span>
            ...
            <div class="progress">
              <span class="skill">Calendar Management <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Data Entry <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">File Management <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Troubleshooting & Technical Support<i class="val">80%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>A dedicated and reliable individual eager to gain practical work experience. Possesses excellent time management skills and the ability to balance work and education effectively. Demonstrates strong communication skills, both weitten and verbal, along with keen eye for detail.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              <h4>Bachelor of Science in Business Administration - Operations and Service Management</h4>
              <h5>2020 - Present</h5>
              <p><em>Far Eastern University - Diliman, Philippines</em></p>
              <p>Excel in the intricacies of business operations and service management with a Bachelor of Science in Business Administration at FEU Diliman, where theoretical knowledge meets practical application to prepare you for a dynamic career at the forefront of organizational efficiency and customer satisfaction.</p>
            </div>
            <div class="resume-item">
              <h4>Accountancy, Business, and Management</h4>
              <h5>2018 - 2020</h5>
              <p><em>Diliman College, Philippines</em></p>
              <p>Embark on a comprehensive journey of financial expertise and strategic leadership with a senior high school education in Accountancy, Business, and Management at Diliman College, cultivating the skills essential for a successful future in the dynamic world of commerce.</p>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <h5>2022 - Present</h5>
              <p><em>Charm Miles Enterprise, Philippines</em></p>
              <ul>
                <li>Managed the design, development, and implementation of graphic, layout, and production communication materials</li>
                <li>Oversaw task delegation to the 7 members of the design team, providing guidance on all project aspects</li>
                <li>Supervised the assessment of all graphic materials to ensure design quality and accuracy</li>
                <li>Administered the efficient utilization of production project budgets ranging from $2,000 to $25,000</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>Technical Support</h4>
              <h5>2021 - 2022</h5>
              <p><em>Alorica, Philippines</em></p>
              <ul>
                <li>Provided technical assistance and support to clients in resolving software and hardware issues</li>
                <li>Managed and prioritized up to 5 technical projects or tasks concurrently, even in high-pressure situations</li>
                <li>Offered recommendations and consultations to clients on the most suitable technical solutions</li>
                <li>Developed and delivered 4+ technical presentations and proposals monthly for clients and account managers</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section id="gallery" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-experiences">Experiences</li>
              <li data-filter=".filter-hobbies">Hobbies</li>
              <li data-filter=".filter-travels">Travels</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <!-- DONE -->
          <div class="col-lg-4 col-md-6 portfolio-item filter-travels">
            <div class="portfolio-wrap">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <h3>John Chris Cayetano</h3>
                <h4>Third Wheel &amp; Friend</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  While I may have a tendency to forget things, one memory that has stayed with me is seeing her at church during the pandemic. She exuded enthusiasm, charm, and a strong work ethic that left a lasting impression.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
              </div>
            </div><!-- End testimonial item -->
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>ryzlbeltran@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-circle"></i>
                <h4>Treat me, if you want to meet me!</h4>
                <p>I love seafoods, hehe.</p>
              </div>
